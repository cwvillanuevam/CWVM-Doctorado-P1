function evain(TT,SPEED,N,T,V,S,B,lambda,Pbmin,Pbmax,Psys,R,X,...
...
Rs.form='full';
Rs.type='parameter';
Rs.uels={tset.uels vset.uels sset.uels};

Xs.name='X';
Xs.val=X;
Xs.form='full';
Xs.type='parameter';
Xs.uels={tset.uels vset.uels sset.uels};
...
wgdx('in.gdx',vset,tset,tiniset,tinivalidset,t1set,...
    t0set,tprevset,sset,bset,lambdas,Pbmins,Pbmaxs,...
    Psyss,Rs,Xs,SoCinits,CESs,mESs,piss);%,ttset,speedset,nset,Pvmaxs,nchgs,ndsgs,...    BCESs,SoCmins,SoCmaxs,
